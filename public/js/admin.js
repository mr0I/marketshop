...
__webpack_require__(/*! ./js/jquery-2.1.1.min.js */ "./resources/js/js/jquery-2.1.1.min.js");

__webpack_require__(/*! ./js/bootstrap.min.js */ "./resources/js/js/bootstrap.min.js");

__webpack_require__(/*! ./js/jquery.easing-1.3.min.js */ "./resources/js/js/jquery.easing-1.3.min.js");

__webpack_require__(/*! ./js/jquery.dcjqaccordion.min.js */ "./resources/js/js/jquery.dcjqaccordion.min.js");

__webpack_require__(/*! ./js/owl.carousel.min.js */ "./resources/js/js/owl.carousel.min.js");

__webpack_require__(/*! ./js/custom.js */ "./resources/js/js/custom.js");
...
(function ($) {
  ...
  $("#latest_category .tab_content:first").show(); //Default Action
  ...
  $("#product-tab .tab_content:first").show(); //Default Action
  ...
  $('#menu .nav > li > .dropdown-menu').closest("li").addClass('sub'); // Clearfix for sub Menu column
  ...
  $('#menu .nav > li > div > .column > div, .submenu, #menu .nav > li .dropdown-menu').before('<span class="submore"></span>'); //mobile sub menu click function
...
/***/ "./resources/js/js/jquery-2.1.1.min.js":
/*!*********************************************!*\
  !*** ./resources/js/js/jquery-2.1.1.min.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./resources/js/js/jquery.dcjqaccordion.min.js":
/*!*****************************************************!*\
  !*** ./resources/js/js/jquery.dcjqaccordion.min.js ***!
  \*****************************************************/
/*! no static exports found */
    ...
    this.each(function () {
      function a() {
        ...
        $objSub.show(), s("li", u).each(function () {
          ...
          if (1 == t.disableLink) var a = parseInt(s("ul a:not(." + t.classParent + ")", this).length);else var a = parseInt(s("ul a", this).length);
...
/***/ "./resources/js/js/jquery.easing-1.3.min.js":
/*!**************************************************!*\
  !*** ./resources/js/js/jquery.easing-1.3.min.js ***!
  \**************************************************/
/*! no static exports found */
  ...
  var i = {
    ...
    updatePagination: function updatePagination() {
      ...
      for (r.paginationWrapper.html(""), e = 0, o = r.itemsAmount - r.itemsAmount % r.options.items, n = 0; n < r.itemsAmount; n += 1) {
        n % r.options.items === 0 && (e += 1, o === n && (i = r.itemsAmount - r.options.items), s = t("<div/>", {
          "class": "owl-page"
        }), a = t("<span></span>", {
    ...
    gestures: function gestures() {
      ...
      function a(n) {
        ...
        l.newPosX = i(r).x - p.offsetX, l.newPosY = i(r).y - p.offsetY, l.newRelativeX = l.newPosX - p.relativePos, "function" == typeof l.options.startDragging && p.dragging !== !0 && 0 !== l.newRelativeX && (p.dragging = !0, l.options.startDragging.apply(l, [l.$elem])), (l.newRelativeX > 8 || l.newRelativeX < -8) && l.browser.isTouch === !0 && (void 0 !== r.preventDefault ? r.preventDefault() : r.returnValue = !1, p.sliding = !0), (l.newPosY > 10 || l.newPosY < -10) && p.sliding === !1 && t(o).off("touchmove.owl"), s = function s() {
    ...
    lazyLoad: function lazyLoad() {
      ...
      for (e = 0; e < a.itemsAmount; e += 1) {
        o = t(a.$owlItems[e]), "loaded" !== o.data("owl-loaded") && (i = o.data("owl-item"), n = o.find(".lazyOwl"), "string" == typeof n.data("src") ? (void 0 === o.data("owl-loaded") && (n.hide(), o.addClass("loading").data("owl-loaded", "checked")), s = a.options.lazyFollow === !0 ? i >= a.currentItem : !0, s && i < a.currentItem + a.options.items && n.length && n.each(function () {
          a.lazyPreload(o, t(this));
        })) : o.data("owl-loaded", "loaded"));
      }
    },
    lazyPreload: function lazyPreload(t, o) {
      function i() {
    ...
    completeImg: function completeImg(t) {
      var e;
      return t.complete ? (e = _typeof(t.naturalWidth), "undefined" !== e && 0 === t.naturalWidth ? !1 : !0) : !1;
    },
...
__webpack_require__(/*! H:\WEB\PHP\new tut\laravel\Project\4-shopping\marketshop\resources\js\admin.js */"./resources/js/admin.js");
module.exports = __webpack_require__(/*! H:\WEB\PHP\new tut\laravel\Project\4-shopping\marketshop\resources\sass\admin.scss */"./resources/sass/admin.scss");
